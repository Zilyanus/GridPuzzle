...
namespace ZilyanusLib
{
    ...
    {
        [MenuItem("GameObject/UI/Button - Custom", false, 2001)]
        static GameObject CreateCustomButton(MenuCommand menuCommand)
        {
            GameObject buttonRoot = CreateUIElementRoot("Custom Button", menuCommand, s_ThickGUIElementSize);
            ...
            text.text = "<b>Custom Button</b>";
            text.fontSize = 20f;
            text.alignment = TextAlignmentOptions.Center;
            text.color = new Color(0.5f, 0, 1);
        ...
        [MenuItem("GameObject/UI/Button - Custom - Sound", false, 2001)]
        static void CreateCustomButtonWithSound(MenuCommand menuCommand)
        {
            GameObject CustomButton = CreateCustomButton(menuCommand);
            CustomButton.GetComponent<CustomButton>().ButtonSound = "ButtonSound";
        }
        ...
        static public GameObject GetOrCreateCanvasGameObject()
        {
            ...
            return CreateUIElements.CreateNewUI();
        }
